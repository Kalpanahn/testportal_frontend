            ...
            <Box sx={{ padding: { xs: 2, md: 4 }, border: "1px solid #e0e0e0", borderRadius: 2, boxShadow: 2, backgroundColor: "#fff" }}>
              ...
              {activeTab === "KGID" && (
                <form onSubmit={handleSubmit}>
                  ...
                  <TextField
                    fullWidth
                    placeholder="Please Enter KGID Number"
                    margin="normal"
                    variant="outlined"
                    value={kgidNumber}
      ...
      <StyledDialog open={openModal} onClose={handleModalClose}>
        ...
        <DialogContent>
          ...
          <Grid container spacing={2} justifyContent="center">
            <Grid item>
            <Button variant="contained" href="/Home" color="primary" sx={{ backgroundColor: "#5c1f45" }}>
                CONTINUE
              </Button>
            </Grid>
            <Grid item>
